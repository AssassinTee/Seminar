...
public class MxnetPredictor {
	Predictor predictor = null;
	String modelPathPrefix;
	List<Context> context;
	
	public MxnetPredictor(String modelPathPrefix, Shape inputShape)
	{
	...
	{
		//XXX shape
		NDArray nd = new NDArray(data, new Shape(new int[]{1, 1, 1, data.length}), context.get(0));
